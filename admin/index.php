                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                <?php
                                    ...
                                    $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $unapproved_comment_count, $user_counts, $subscriber_count, $category_counts];
